-file("/usr/local/lib/erlang/lib/parsetools-2.0/include/leexinc.hrl", 0).
...
-file("src/example_scanner.xrl", 20).

-file("/usr/local/lib/erlang/lib/parsetools-2.0/include/leexinc.hrl", 14).
...
-file("src/example_scanner.erl", 276).
yystate() -> 17.
...
yystate(19, [10|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line+1, Tlen+1, 11, Tlen);
...
yystate(18, Ics, Line, Tlen, _, _) ->
    {2,Tlen,Ics,Line};
yystate(17, [226|Ics], Line, Tlen, Action, Alen) ->
...
yystate(17, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
...
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 36 ->
    yystate(15, Ics, Line, Tlen+1, 11, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 38 ->
    yystate(15, Ics, Line, Tlen+1, 11, Tlen);
yystate(15, Ics, Line, Tlen, _, _) ->
    {11,Tlen,Ics,Line,15};
yystate(14, [147|Ics], Line, Tlen, Action, Alen) ->
    yystate(18, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [136|Ics], Line, Tlen, Action, Alen) ->
    yystate(20, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [130|Ics], Line, Tlen, Action, Alen) ->
    yystate(16, Ics, Line, Tlen+1, Action, Alen);
yystate(14, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,14};
yystate(13, [158|Ics], Line, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(13, [157|Ics], Line, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Tlen+1, Action, Alen);
yystate(13, [156|Ics], Line, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(13, [151|Ics], Line, Tlen, Action, Alen) ->
...
yystate(10, Ics, Line, Tlen, _, _) ->
    {9,Tlen,Ics,Line};
yystate(9, [189|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(9, [184|Ics], Line, Tlen, Action, Alen) ->
    yystate(1, Ics, Line, Tlen+1, Action, Alen);
yystate(9, [159|Ics], Line, Tlen, Action, Alen) ->
...
yystate(7, Ics, Line, Tlen, _, _) ->
    {5,Tlen,Ics,Line,7};
yystate(6, [164|Ics], Line, Tlen, Action, Alen) ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(6, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,6};
yystate(5, Ics, Line, Tlen, _, _) ->
    {1,Tlen,Ics,Line};
yystate(4, [165|Ics], Line, Tlen, Action, Alen) ->
    yystate(0, Ics, Line, Tlen+1, Action, Alen);
yystate(4, [164|Ics], Line, Tlen, Action, Alen) ->
...
-file("src/example_scanner.xrl", 5).
yy_0_(TokenLine) ->
     { token , { module , TokenLine } } .

-compile({inline,yy_1_/1}).
-file("src/example_scanner.xrl", 6).
yy_1_(TokenLine) ->
     { token , { function , TokenLine } } .

-compile({inline,yy_2_/1}).
-file("src/example_scanner.xrl", 7).
yy_2_(TokenLine) ->
     { token , { '->' , TokenLine } } .

-compile({inline,yy_3_/1}).
-file("src/example_scanner.xrl", 8).
yy_3_(TokenLine) ->
     { token , { '[' , TokenLine } } .

-compile({inline,yy_4_/1}).
-file("src/example_scanner.xrl", 9).
yy_4_(TokenLine) ->
     { token , { ']' , TokenLine } } .

-compile({inline,yy_5_/2}).
-file("src/example_scanner.xrl", 10).
yy_5_(TokenChars, TokenLine) ->
     { token , { atom , TokenLine , list_to_atom ( TokenChars ) } } .

-compile({inline,yy_6_/2}).
-file("src/example_scanner.xrl", 11).
yy_6_(TokenChars, TokenLine) ->
     { token , { integer , TokenLine , list_to_integer ( TokenChars ) } } .

-compile({inline,yy_7_/1}).
-file("src/example_scanner.xrl", 12).
yy_7_(TokenLine) ->
     { token , { '<-' , TokenLine } } .

-compile({inline,yy_8_/1}).
-file("src/example_scanner.xrl", 13).
yy_8_(TokenLine) ->
     { token , { '||' , TokenLine } } .

-compile({inline,yy_9_/1}).
-file("src/example_scanner.xrl", 14).
yy_9_(TokenLine) ->
     { token , { heart , TokenLine } } .

-compile({inline,yy_10_/1}).
-file("src/example_scanner.xrl", 15).
yy_10_(TokenLine) ->
     { end_token , { dot , TokenLine } } .

-compile({inline,yy_11_/0}).
-file("src/example_scanner.xrl", 16).
yy_11_() ->
     skip_token .

-file("/usr/local/lib/erlang/lib/parsetools-2.0/include/leexinc.hrl", 282).
